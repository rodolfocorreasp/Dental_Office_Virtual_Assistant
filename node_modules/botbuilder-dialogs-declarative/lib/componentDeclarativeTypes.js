...
exports.isComponentDeclarativeTypes = void 0;
const z = require("zod");
const componentDeclarativeTypes = z.custom((val) => typeof val.getDeclarativeTypes === 'function', { message: 'ComponentDeclarativeTypes' });
/**
