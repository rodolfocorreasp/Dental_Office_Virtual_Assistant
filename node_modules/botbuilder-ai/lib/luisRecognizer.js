...
const UnsafeLuisRecognizerUnion = z.custom((val) => z.record(z.unknown()).safeParse(val).success, {
...
class LuisRecognizer {
    ...
    constructor(application, options, includeApiResults) {
        if (typeof application === 'string') {
            const parsedEndpoint = (0, url_parse_1.default)(application);
        ...
        else if ((0, luisRecognizerOptionsV3_1.isLuisRecognizerOptionsV3)(options)) {
            this.luisRecognizerInternal = new luisRecognizerOptionsV3_1.LuisRecognizerV3(this.application, options);
        }
        else if ((0, luisRecognizerOptionsV2_1.isLuisRecognizerOptionsV2)(options)) {
    ...
    buildRecognizer(userOptions) {
        if ((0, luisRecognizerOptionsV3_1.isLuisRecognizerOptionsV3)(userOptions)) {
            return new luisRecognizerOptionsV3_1.LuisRecognizerV3(this.application, userOptions);
        }
        else if ((0, luisRecognizerOptionsV2_1.isLuisRecognizerOptionsV2)(userOptions)) {
