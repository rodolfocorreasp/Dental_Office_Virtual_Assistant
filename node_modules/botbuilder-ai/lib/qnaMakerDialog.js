...
const customQuestionAnswering_1 = require("./customQuestionAnswering");
const serviceType_1 = require("./qnamaker-interfaces/serviceType");
...
const qnaSuggestionsActivityFactory = z.custom((val) => typeof val === 'function', {
...
class QnAMakerDialog extends botbuilder_dialogs_1.WaterfallDialog {
     ...
     * @internal
     */
    constructor(knowledgeBaseId, endpointKey, hostname, noAnswer, threshold, activeLearningTitleOrFactory, cardNoMatchText, top, cardNoMatchResponse, rankerType, strictFilters, dialogId = 'QnAMakerDialog', 
    ...
    strictFiltersJoinOperator, enablePreciseAnswer, displayPreciseAnswerOnly, qnaServiceType, useTeamsAdaptiveCard) {
        var _a;
        super(dialogId);
        ...
        this.turnQnaresult = 'turnQnaresult';
        this.defaultNoAnswer = '';
        // Card parameters
         ...
         */
        this.useTeamsAdaptiveCard = false;
        if (knowledgeBaseId) {
        ...
        if (qnaSuggestionsActivityFactoryParsed.success) {
            ...
            this.activeLearningCardTitle = new adaptive_expressions_1.StringExpression((_a = activeLearningTitleOrFactory === null || activeLearningTitleOrFactory === void 0 ? void 0 : activeLearningTitleOrFactory.toString()) !== null && _a !== void 0 ? _a : this.defaultCardTitle);
        }
        if (cardNoMatchText) {
        ...
        if (rankerType != undefined) {
            this.rankerType = new adaptive_expressions_1.EnumExpression(rankerType);
        }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (e.name === 'error') {
                ...
                if (suggestedQuestions) {
                    if (suggestedQuestions === null || suggestedQuestions === void 0 ? void 0 : suggestedQuestions.some((question) => question.toLowerCase() === reply.toLowerCase().trim())) {
    ...
    getQnAMakerClient(dc) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const endpoint = {
                ...
                host: this.qnaServiceType === serviceType_1.ServiceType.language ? this.hostname.getValue(dc.state) : this.getHost(dc),
            ...
            if (endpoint.qnaServiceType === serviceType_1.ServiceType.language) {
                return new customQuestionAnswering_1.CustomQuestionAnswering(endpoint, yield this.getQnAMakerOptions(dc), this.telemetryClient, logPersonalInformation);
            }
            else {
    ...
    getQnAMakerOptions(dc) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return {
                ...
                top: (_d = (_c = this.top) === null || _c === void 0 ? void 0 : _c.getValue(dc.state)) !== null && _d !== void 0 ? _d : this.defaultTopN,
                qnaId: 0,
                rankerType: (_f = (_e = this.rankerType) === null || _e === void 0 ? void 0 : _e.getValue(dc.state)) !== null && _f !== void 0 ? _f : qnamaker_interfaces_1.RankerTypes.default,
                isTest: this.isTest,
    ...
    getQnAResponseOptions(dc) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return {
                activeLearningCardTitle: (_b = (_a = this.activeLearningCardTitle) === null || _a === void 0 ? void 0 : _a.getValue(dc === null || dc === void 0 ? void 0 : dc.state)) !== null && _b !== void 0 ? _b : this.defaultCardTitle,
                cardNoMatchResponse: this.cardNoMatchResponse && (yield this.cardNoMatchResponse.bind(dc, dc === null || dc === void 0 ? void 0 : dc.state)),
                cardNoMatchText: (_d = (_c = this.cardNoMatchText) === null || _c === void 0 ? void 0 : _c.getValue(dc === null || dc === void 0 ? void 0 : dc.state)) !== null && _d !== void 0 ? _d : this.defaultCardNoMatchText,
                noAnswer: yield ((_e = this.noAnswer) === null || _e === void 0 ? void 0 : _e.bind(dc, dc === null || dc === void 0 ? void 0 : dc.state)),
    ...
    displayQnAResult(step) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = typeof step.result === 'string'
                ? (_a = step.values[this.turnQnaresult]) === null || _a === void 0 ? void 0 : _a.filter((ans) => ans.questions[0] === step.result)
                : step.result;
            if ((response === null || response === void 0 ? void 0 : response.length) > 0) {
                const activity = dialogOptions.qnaDialogResponseOptions.noAnswer;
                if (response[0].id !== -1) {
                    const message = qnaCardBuilder_1.QnACardBuilder.getQnAAnswerCard(response[0], this.displayPreciseAnswerOnly, this.useTeamsAdaptiveCard);
                    yield step.context.sendActivity(message);
                }
                else {
                    if (activity && activity.text) {
                        yield step.context.sendActivity(activity);
                    }
                    else {
                        const message = qnaCardBuilder_1.QnACardBuilder.getQnAAnswerCard(response[0], this.displayPreciseAnswerOnly, this.useTeamsAdaptiveCard);
                        yield step.context.sendActivity(message);
                ...
                yield step.context.sendActivity('No QnAMaker answers found.');
            }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (qnaResponse.answers.length > 0 &&
                ...
                if (isActiveLearningEnabled && ((_a = qnaResponse.answers) === null || _a === void 0 ? void 0 : _a.length) > 1) {
                    ...
                    if ((suggestedQuestions === null || suggestedQuestions === void 0 ? void 0 : suggestedQuestions.length) > 0) {
    ...
    callTrain(step) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const dialogOptions = step.activeDialog.state[this.options];
            const trainResponses = step.values[this.turnQnaresult];
    ...
    checkForMultiTurnPrompt(step) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((response === null || response === void 0 ? void 0 : response.length) > 0 && response[0].id != -1) {
                ...
                if (((_b = (_a = answer === null || answer === void 0 ? void 0 : answer.context) === null || _a === void 0 ? void 0 : _a.prompts) === null || _b === void 0 ? void 0 : _b.length) > 0) {
                    ...
                    step.activeDialog.state[this.options] = dialogOptions;
                    const message = qnaCardBuilder_1.QnACardBuilder.getQnAAnswerCard(answer, this.displayPreciseAnswerOnly, this.useTeamsAdaptiveCard);
                    yield step.context.sendActivity(message);
                    return botbuilder_dialogs_1.Dialog.EndOfTurn;
                }
            }
