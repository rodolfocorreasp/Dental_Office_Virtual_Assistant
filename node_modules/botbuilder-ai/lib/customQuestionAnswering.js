...
class CustomQuestionAnswering {
    ...
    getKnowledgebaseAnswersRaw(context, options, telemetryProperties, telemetryMetrics) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const userId = (_b = (_a = context === null || context === void 0 ? void 0 : context.activity) === null || _a === void 0 ? void 0 : _a.from) === null || _b === void 0 ? void 0 : _b.id;
            const queryOptions = Object.assign(Object.assign(Object.assign({}, this._options), options), { userId });
            let result;
