...
class QnAMaker {
    ...
    constructor(endpoint, options = {}, telemetryClient, logPersonalInformation) {
        ...
        const { scoreThreshold = 0.3, top = 1, strictFilters = [], metadataBoost = [], filters = { metadataFilter: { metadata: [] }, sourceFilter: [] }, timeout = 100000, rankerType = qnamaker_interfaces_1.RankerTypes.default, } = options;
        this._options = {
            scoreThreshold,
            top,
            strictFilters,
    ...
    getAnswersRaw(context, options, telemetryProperties, telemetryMetrics) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.getLegacyAnswersRaw(context, options, telemetryProperties, telemetryMetrics);
        });
    }
    /**
     ...
     * @returns {Promise<QnAMakerResults>} A list of answers for the user query, sorted in decreasing order of ranking score.
     */
    getLegacyAnswersRaw(context, options, telemetryProperties, telemetryMetrics) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const sortedQnaAnswers = qnamaker_utils_1.GenerateAnswerUtils.sortAnswersWithinThreshold(result === null || result === void 0 ? void 0 : result.answers, queryOptions);
     ...
     */
    generateAnswer(question, top, _scoreThreshold) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (trimmedAnswer.length > 0) {
                ...
                return result.answers.sort((a, b) => b.score - a.score);
            }
            return [];
        });
    }
