...
class LuisRecognizerV3 extends luisRecognizerOptions_1.LuisRecognizerInternal {
    ...
    recognizeInternal(contextOrUtterance) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (typeof contextOrUtterance === 'string') {
                ...
                if (contextOrUtterance instanceof botbuilder_dialogs_1.DialogContext) {
    ...
    recognize(context, utterance, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const data = yield (0, node_fetch_1.default)(uri, httpOptions);
    ...
    buildRequestBody(utterance, options) {
        ...
        if (options.dynamicLists) {
            options.dynamicLists.forEach((list) => (0, dynamicList_1.validateDynamicList)(list));
            content['dynamicLists'] = options.dynamicLists;
        }
        if (options.externalEntities) {
            options.externalEntities.forEach((entity) => (0, externalEntity_1.validateExternalEntity)(entity));
