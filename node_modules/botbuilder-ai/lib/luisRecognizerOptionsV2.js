...
exports.LuisRecognizerV2 = exports.isLuisRecognizerOptionsV2 = void 0;
const botframework_connector_1 = require("botframework-connector");
const os = __importStar(require("os"));
const luisRuntimeClientV2_1 = require("./luisV2-models/luisRuntimeClientV2");
...
class LuisRecognizerV2 extends luisRecognizerOptions_1.LuisRecognizerInternal {
    ...
    constructor(application, options) {
        ...
        const creds = new botframework_connector_1.TokenCredentials(application.endpointKey);
        const baseUri = application.endpoint || 'https://westus.api.cognitive.microsoft.com';
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        this.luisClient = new luisRuntimeClientV2_1.LUISRuntimeClientV2(creds, baseUri);
     ...
     * @internal
     */
    recognizeInternal(contextOrUtterance) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (typeof contextOrUtterance === 'string') {
                ...
                context = contextOrUtterance instanceof botbuilder_core_1.TurnContext ? contextOrUtterance : contextOrUtterance.context;
    ...
    populateCompositeEntity(compositeEntity, entities, entitiesAndMetadata, // eslint-disable-line @typescript-eslint/no-explicit-any
    verbose) {
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
